export const vectorTileBaseMaps = [
  ...
  {
    name: 'light gray',
    style: 'https://api.maptiler.com/maps/dataviz-light/style.json?key=DifPnucmd6PF6UqDKcMm',
  },
  {
    name: 'dark gray',
    style: 'https://api.maptiler.com/maps/dataviz-dark/style.json?key=DifPnucmd6PF6UqDKcMm',
  },
];
