...
import { GeolabLineDraw, GeolabPolygonDraw } from 'shared/modules/gis/drawing';
...
let drawObj: GeolabPolygonDraw | GeolabLineDraw | undefined;
export const DrawingControl = (props: DrawingControlProps) => {
  ...
  useEffect(() => {
    if (!drawingType) {
      drawObj && drawObj.remove();
      drawObj = undefined;
      return;
    }
    if (drawingType === 'polygon') drawObj = new GeolabPolygonDraw();
    else drawObj = new GeolabLineDraw();
